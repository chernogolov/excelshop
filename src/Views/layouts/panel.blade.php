            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item @if (Route::currentRouteName() == 'goods') active @endif ">
                            <a class="nav-link" href="{{ route('goods') }}">{{__('Goods')}}</a>
                        </li>
                        <li class="nav-item @if (Route::currentRouteName() == 'design') active @endif ">
                            <a class="nav-link" href="{{ route('design') }}">{{__('Design')}}</a>
                        </li>
                        <li class="nav-item @if (Route::currentRouteName() == 'seo') active @endif ">
                            <a class="nav-link" href="{{ route('seo') }}">{{__('SEO')}}</a>
                        </li>
